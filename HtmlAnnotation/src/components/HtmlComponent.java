...
public abstract class HtmlComponent {
	...
	public static String createMiddleStruct(Class<?> klass) {
		...
		for (Field field : klass.getDeclaredFields()) {
			...
			if(field.getType() == Sexo.class){
				for(Field fieldEnum : Sexo.class.getDeclaredFields()){
					buffer.append(createComboBox(fieldEnum));
				}
			}
	...
	public static String createComboBox(Field fieldEnum){
		StringBuffer buffer = new StringBuffer();
		buffer.append("<div class=\"uk-margin\">")
		.append("<label class=\"uk-form-label\" for=\"" + fieldEnum.getName() + "\">")
		.append(fieldEnum.getName()) //Nome da Label
		.append("</label>")
		.append("<div class=\"uk-form-controls\">")
		.append("<select class=\"uk-input\" id=\"" + fieldEnum.getName() + "\" type=\"text>")
		.append("<option>" + fieldEnum.getName() + "</option></select>")
		.append("</div>")
		.append("</div>");
		return buffer.toString();
	}
